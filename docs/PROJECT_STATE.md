...
- Forty-two targeted backend tests across Current Affairs and UPSC Notes pass 100%. Backend startup smoke test passes. Frontend typecheck (`npx tsc --noEmit`) and frontend production build (`npm run build`) pass with zero errors.
